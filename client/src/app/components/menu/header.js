                      ...
                      {openMenu && (
                        <div className="item-dropdown">
                          <div className="dropdown" onClick={closeMenu}>
                            <NavLink to="/homeGrey" onClick={() => btn_icon(!showmenu)}>
                              Homepage Grey
                            </NavLink>
                            ...
                            <NavLink to="/home1Grey" onClick={() => btn_icon(!showmenu)}>
                              Homepage 1 Grey
                            </NavLink>
                            <NavLink to="/home2" onClick={() => btn_icon(!showmenu)}>
                              Homepage 2
                            </NavLink>
                            <NavLink to="/home2Grey" onClick={() => btn_icon(!showmenu)}>
                              Homepage 2 Grey
                            </NavLink>
                      ...
                      {openMenu1 && (
                        <div className="item-dropdown">
                          <div className="dropdown" onClick={closeMenu1}>
                            ...
                            <NavLink to="/ItemDetailGrey/1" onClick={() => btn_icon(!showmenu)}>
                              Items Details Grey
                            </NavLink>
                            <NavLink to="/Auction" onClick={() => btn_icon(!showmenu)}>
                              Live Auction
                            </NavLink>
                            <NavLink to="/AuctionGrey" onClick={() => btn_icon(!showmenu)}>
                              Live Auction Grey
                            </NavLink>
                      ...
                      {openMenu2 && (
                        <div className="item-dropdown">
                          <div className="dropdown" onClick={closeMenu2}>
                            ...
                            <NavLink to="/AuthorGrey/1" onClick={() => btn_icon(!showmenu)}>
                              Author Grey
                            </NavLink>
                            ...
                            <NavLink to="/create2" onClick={() => btn_icon(!showmenu)}>
                              Create 2
                            </NavLink>
                            ...
                            <NavLink to="/minter" onClick={() => btn_icon(!showmenu)}>
                              Nft Minting Grey
                            </NavLink>
                ...
                {showpop && (
                  <div className="popshow">
                    ...
                    <div className="d-wallet">
                      ...
                      <button id="btn_copy" title="Copy Text" onClick={() => {navigator.clipboard.writeText(user.address)}}>
                        Copy
                      </button>
                    </div>
